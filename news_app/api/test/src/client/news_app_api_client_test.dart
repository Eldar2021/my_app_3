...
void main() {
  ...
  group('NewsAppApiClient', () {
    late http.Client httpClient;
    late NewsAppApiClient apiClient;
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => NewsAppApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = NewsAppApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws NewsAppApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<NewsAppApiMalformedResponse>()),
        );
      });

      test(
          'throws NewsAppApiRequestFailure '
