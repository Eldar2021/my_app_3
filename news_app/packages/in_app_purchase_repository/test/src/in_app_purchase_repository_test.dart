...
import 'package:news_app_api/client.dart' hide User;
import 'package:news_app_api/client.dart' as api;
import 'package:in_app_purchase/in_app_purchase.dart';
import 'package:in_app_purchase_repository/in_app_purchase_repository.dart';
import 'package:mocktail/mocktail.dart';
import 'package:test/test.dart';

class MockNewsAppApiClient extends Mock
    implements NewsAppApiClient {}
...
void main() {
  ...
  group('InAppPurchaseRepository', () {
    ...
    setUp(() {
      ...
      apiClient = MockNewsAppApiClient();
