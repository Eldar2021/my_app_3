...
import 'package:news_app_api/client.dart';

/// {@template news_app_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class NewsAppApiMalformedResponse implements Exception {
  /// {@macro news_app_api_malformed_response}
  const NewsAppApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template news_app_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class NewsAppApiRequestFailure implements Exception {
  /// {@macro news_app_api_request_failure}
  const NewsAppApiRequestFailure({
...
/// {@template news_app_api_client}
/// A Dart API client for the news_app API.
/// {@endtemplate}
class NewsAppApiClient {
  /// Create an instance of [NewsAppApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro news_app_api_client}
  NewsAppApiClient({
  ...
  Future<ArticleResponse> getArticle({
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw NewsAppApiRequestFailure(
        body: body,
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        NewsAppApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
